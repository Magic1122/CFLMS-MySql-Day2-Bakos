-- A trigger is an sql code which will be executed in a certain predefined situation

CREATE TABLE trigger_test (
    message VARCHAR(100)
);

-- we must use terminal to use triggers
-- steps
-- use giraffe
-- to change the delimiter, because we need the semicolon after INSERT INTO
